...
class SSDNet_vgg_512(object):
    def __init__(self):
        # 获取feature map层
        self.anchors_blocks = ['block1','block2','block3','block4', 'block7', 'block8', 'block9', 'block10']  # block的索引
        # anchor的层
        self.anchors_steps = (1,2,4,8,16, 32, 64,128)
        # 补偿阀值0.5
        self.offset = 0.5
        # anchor boxes的aspect ratios
        self.anchors_ratios = [[2, .5, 1, 3, 1/3.0],
                               [2, .5, 1, 3, 1/3.0],
                               [2, .5, 1, 3, 1/3.0],
                               [2, .5, 1, 3, 1/3.0],
                               [2, .5, 1, 3, 1/3.0],
        ...
        self.anchors_sizes = [(2,4),
                              ...
                              (215.04, 296.96),
                              (296.96, 378.88)]
        self.feat_shapes = [(512,512),(256,256),(128,128),(64, 64), (32, 32), (16, 16), (8, 8),(4,4)]
        self.img_size = 512
        self.num_classes = 4
